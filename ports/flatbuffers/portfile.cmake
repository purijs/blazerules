...
if(EXISTS "/usr/local/bin/flatc")
    file(REMOVE "${CURRENT_PACKAGES_DIR}/tools/flatbuffers/flatc")
    file(INSTALL "/usr/local/bin/flatc"
         DESTINATION "${CURRENT_PACKAGES_DIR}/tools/flatbuffers"
